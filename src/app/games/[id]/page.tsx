  ...
  return (
    ...
    >
      <div className="card overflow-hidden">
        <div className="relative aspect-[3/1] min-h-56 bg-slate-900">
          ...
          <div className="absolute bottom-0 left-0 p-6 md:p-8">
            ...
            <p className="mt-2 text-sm text-slate-300">by {game.creatorName}</p>
          </div>
          ...
          <section className="card p-6">
            ...
            <ul className="mt-4 space-y-3 text-sm leading-6 text-slate-400">
              {game.score.risks.map((risk) => (
                <li key={risk} className="border-l-2 border-orange-500/50 pl-3">
                  {risk}
                </li>
              ))}
            </ul>
      ...
      <p className="mt-10 text-center text-xs text-slate-500">
        Use these signals for inspiration. Do not clone assets, names, maps, UI,
        or copyrighted material from other games.
      </p>
    </AppShell>
  );
}
